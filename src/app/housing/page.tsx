            ...
            <div className="area-card">
              ...
              <div className="area-card-body">
                ...
                <div style={{background:'rgba(201,168,76,0.06)', border:'1px solid rgba(201,168,76,0.3)', borderLeft:'3px solid #C9A84C', padding:'24px 28px', marginTop:'20px'}}>
                  ...
                  <BodyText variant="light-bg" style={{fontSize:'0.87rem', fontWeight:300, lineHeight:1.75, marginBottom:'16px'}}>IT Park has the most reliable power infrastructure of any residential area in Cebu. Multiple backup generators serve the commercial and residential towers. Internet is excellent — PLDT, Converge, and Globe all have strong coverage and most buildings have fiber backbone. For remote workers this infrastructure advantage over other Mactan and Cebu areas is significant. The digital infrastructure is genuinely better here than anywhere else in Cebu.</BodyText>

                  <p style={{fontSize:'0.8rem', fontWeight:700, color:'#0B1F3A', marginBottom:'6px'}}>The Noise Reality</p>
                  <BodyText variant="light-bg" style={{fontSize:'0.87rem', fontWeight:300, lineHeight:1.75, marginBottom:'16px'}}>IT Park houses major BPO operations — call centers and back-office operations running 24 hours a day 7 days a week. This means shift workers coming and going at 2am, 4am, and 6am. The areas immediately surrounding the BPO buildings — particularly the ground floor restaurant and retail strip — are active at unusual hours. Expats who live in upper floors facing the interior park space rather than the street report significantly quieter conditions. If noise is a concern ask specifically which direction the unit faces and what floor it is on before committing.</BodyText>

                  <p style={{fontSize:'0.8rem', fontWeight:700, color:'#0B1F3A', marginBottom:'6px'}}>No-Car Lifestyle</p>
                  <BodyText variant="light-bg" style={{fontSize:'0.87rem', fontWeight:300, lineHeight:1.75, marginBottom:'16px'}}>IT Park is one of the few areas in Cebu where a car is genuinely optional. The Sugbo Mercado night market, Ayala Center Cebu, SM Seaside City via Grab, restaurants, cafes, gyms, convenience stores, and medical clinics are all accessible without a vehicle. Grab pickup is fast and reliable within IT Park at virtually any hour due to the constant BPO traffic keeping drivers in the area.</BodyText>

                  <p style={{fontSize:'0.8rem', fontWeight:700, color:'#0B1F3A', marginBottom:'6px'}}>Avida Towers Specifically</p>
                  <BodyText variant="light-bg" style={{fontSize:'0.87rem', fontWeight:300, lineHeight:1.75, marginBottom:'16px'}}>Avida Tower 1 is frequently recommended by long-term IT Park expats as one of the better-managed buildings in the area. Backup power coverage, professional management, and good security track record. Worth specifically asking about when looking for IT Park accommodation.</BodyText>

                  <p style={{fontSize:'0.8rem', fontWeight:700, color:'#0B1F3A', marginBottom:'6px'}}>Rental Agent Over Online Portals</p>
                  <BodyText variant="light-bg" style={{fontSize:'0.87rem', fontWeight:300, lineHeight:1.75, marginBottom:'16px'}}>Multiple experienced IT Park expats specifically recommend using local rental agents rather than relying solely on online property portals for IT Park units. Agents know which buildings have management issues, which units have recurring maintenance problems, and which landlords are reliable. The commission is typically paid by the landlord not the tenant. Ask in Cebu expat Facebook groups for current rental agent recommendations.</BodyText>

                  <p style={{fontSize:'0.8rem', fontWeight:700, color:'#0B1F3A', marginBottom:'6px'}}>Working From Home Aircon Consideration</p>
                  <BodyText variant="light-bg" style={{fontSize:'0.87rem', fontWeight:300, lineHeight:1.75, marginBottom:'0'}}>Working from home in IT Park means running aircon significantly more than someone who leaves for an office. Budget your electricity at the higher end of the range — 8,000 to 12,000 pesos per month if you run aircon during working hours in a typical 1BR unit. Factor this into your total budget calculation.</BodyText>
                </div>
              </div>
            </div>
