          ...
          <div className="broker-grid">
            ...
            <div className="broker-card">
              ...
              <div style={{background:'rgba(242,153,74,0.08)', border:'1px solid rgba(242,153,74,0.28)', borderLeft:'4px solid #F2994A', padding:'22px 26px', margin:'18px 0', maxWidth:'760px'}}>
                ...
                <BodyText variant="dark-bg" style={{fontSize:'0.9rem', fontWeight:300, lineHeight:1.82}}>If you are currently using your Schwab account from the Philippines without issues do not call Schwab to ask whether your account will remain active. This is the single most common trigger for an account review that leads to closure. The risk of Schwab restricting your account is real but it is not imminent from normal ATM usage and foreign IP addresses alone. Here is what to do instead: Maintain a legitimate US forwarding address — do not update your address to a Philippine address with Schwab. Use a mail forwarding service like Traveling Mailbox so all Schwab correspondence goes to a real US address. Set up backup infrastructure now before you need it — a Wise account for transfers, a Philippine bank account for local needs, and an IBKR account for investments since IBKR explicitly accepts Philippine residents. If Schwab does restrict your account they typically give 30 to 60 days warning — not an immediate freeze — giving you time to transfer assets. The time to set up alternatives is before you need them not after.</BodyText>
              </div>
            </div>
            <div className="broker-card">
              <div className="broker-header">
