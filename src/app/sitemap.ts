...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${base}/divorce-philippines`,     lastModified: lastmod, changeFrequency: "weekly", priority: 0.8 },
    ...
    { url: `${base}/dating-philippines`,      lastModified: lastmod, changeFrequency: "weekly", priority: 0.8 },
    { url: `${base}/retirement-benefits`,     lastModified: lastmod, changeFrequency: "weekly", priority: 0.8 },
